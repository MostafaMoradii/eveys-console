...
Context for anyone (or any future session of mine) working on this
repo. Read in order; each doc is small and single-purpose.
...
| [adr/](./adr/)             | Architecture decision records | The _why_ behind every load-bearing decision. Append-only.                        |
